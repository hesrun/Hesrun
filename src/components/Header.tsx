                ...
                <div className="container mx-auto flex items-center py-4">
                    {!isMd && (
                        <button
                            ...
                            className="ml-auto mr-2 flex cursor-pointer flex-col w-6 h-6 justify-center gap-2 z-[1]"
                        >
                            <span
                    ...
                    <nav
                        ref={mobNav}
                        className="fixed flex flex-col left-0 top-0 right-0 bottom-0 bg-black opacity-0 translate-x-full pointer-events-none md:flex-row md:justify-between md:static md:bg-transparent md:opacity-100 md:translate-x-0 md:pointer-events-auto md:grow"
                    >
